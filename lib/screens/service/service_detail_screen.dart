        ...
        return AppScaffold(
          ...
          child: Column(
            children: [
              ...
              // إظهار زر الطلب فقط إذا لم تكن الخدمة مجانية
              if (!snap.data!.serviceDetail!.isFreeService)
                ...
                Container(
                  ...
                  child: Text(
                    language
                        .contactAdmin, // أو يمكنك تخصيص نص آخر مثل "هذه الخدمة مجانية للاستفسار فقط"
                    ...
                    Navigator.push(
                      ...
                      MaterialPageRoute(
                        builder: (context) => UserChatScreen(
                            receiverUser: provider, isChattingAllow: true),
                      ),
                    );
                  } else {
